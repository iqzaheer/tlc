...
if (isset($_POST['name']) && ($_POST['password']) !=""){
    ...
    $sql = "insert into users (`name`,`email`,`password`,`phone`,`address`,`balance`,`type`) values
                                ('$name','$email','$password',$phone','$address','$balance','3')";
                                    ...
                                    <div class="panel-container show">
                                        <div class="panel-content">
                                            <form method="post">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="simpleinput">Balance</label>
