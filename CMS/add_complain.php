...
<html lang="en">
    ...
    <body class="mod-bg-1 ">
        ...
        echo "<option value='$row[id]'>".$row['name'].", ".$row['email']."</option>";
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Date</label>
                                                    <input type="date" id="address" name='date' class="form-control" placeholder="Date">
                                                </div>

                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Status</label>
                                                    <input type="text" id="phone" name='status' class="form-control" placeholder="Complain Status" >
                                                </div>

                                                <div class="form-group">
                                                    <label class="form-label" for="example-palaceholder">Category</label>
                                                    <input type="text" id="phone" name='category' class="form-control" placeholder="Complain Category" >
                                                </div>
